...
const dummyProjects = [
  { id: "1", title: "The Horizon Villa", category: "Residential", status: "Completed", year: "2024" },
  { id: "2", title: "Meridian Tower", category: "Commercial", status: "Completed", year: "2023" },
  { id: "3", title: "Serenity Residence", category: "Residential", status: "Completed", year: "2024" },
];
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="font-heading text-3xl text-luxury-text mb-2">Projects</h1>
          <p className="text-luxury-ash">Manage your portfolio projects</p>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-100">
                <th className="text-left px-6 py-4 text-xs font-medium text-luxury-ash uppercase tracking-wider">Project</th>
                <th className="text-left px-6 py-4 text-xs font-medium text-luxury-ash uppercase tracking-wider">Category</th>
                <th className="text-left px-6 py-4 text-xs font-medium text-luxury-ash uppercase tracking-wider">Status</th>
                <th className="text-left px-6 py-4 text-xs font-medium text-luxury-ash uppercase tracking-wider">Year</th>
            ...
            <tbody>
              {dummyProjects.map((project, index) => (
                ...
                >
                  <td className="px-6 py-4 font-medium text-luxury-text">{project.title}</td>
                  <td className="px-6 py-4 text-sm text-luxury-ash">{project.category}</td>
                  <td className="px-6 py-4">
                    <span className="inline-flex px-3 py-1 rounded-full text-xs font-medium bg-green-50 text-green-600">
                      {project.status}
                    </span>
                  </td>
                  <td className="px-6 py-4 text-sm text-luxury-ash">{project.year}</td>
