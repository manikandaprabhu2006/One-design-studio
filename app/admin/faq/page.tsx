...
const dummyFaqs = [
  { id: "1", question: "What types of projects do you handle?", category: "General", order: 1 },
  { id: "2", question: "How long does a project take?", category: "Process", order: 1 },
  { id: "3", question: "What is your design process?", category: "Process", order: 2 },
];
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="font-heading text-3xl text-luxury-text mb-2">FAQ</h1>
          <p className="text-luxury-ash">Manage frequently asked questions</p>
        </div>
          ...
          <table className="w-full">
            <thead>
              <tr className="border-b border-gray-100">
                <th className="text-left px-6 py-4 text-xs font-medium text-luxury-ash uppercase tracking-wider">Question</th>
            ...
            <tbody>
              {dummyFaqs.map((faq, index) => (
                ...
                >
                  <td className="px-6 py-4 font-medium text-luxury-text max-w-md truncate">{faq.question}</td>
                  <td className="px-6 py-4 text-sm text-luxury-ash">{faq.category}</td>
                  <td className="px-6 py-4 text-sm text-luxury-ash">{faq.order}</td>
